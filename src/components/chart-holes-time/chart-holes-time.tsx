...
@observer
export class ChartHolesTime extends React.Component<{ intervals: Interval[] }> {
    ...
    @computed public get data() {
        return this.props.intervals.map(({ start, holes }) => ({ start, holes }));
    }
        ...
        return (
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    <Tooltip/>
                    <Legend />
                    <Line type="monotone" dataKey="holes" stroke={chartColors[0]} />
                </LineChart>
            </ResponsiveContainer>
